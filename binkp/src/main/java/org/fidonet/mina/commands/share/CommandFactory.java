...
public class CommandFactory {
    ...
    public static Command createCommand(SessionContext sessionContext, BinkData data) throws IOException, UnknownCommandException {
        if (data.isCommand()) {
            ...
            return createCommand(sessionContext, BinkpCommand.findCommand(data.getCommand()), argsStr);
        }
        return null;
    }

    public static Command createCommand(SessionContext sessionContext, BinkpCommand cmd, String args) throws UnknownCommandException {
